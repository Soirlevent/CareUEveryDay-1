...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        GirlFriend girlFriend = new GirlFriend("某女友",
                "江苏省", "南京市", "1999-08-08", "2011-04-16", "oHapj6IiKHSeTW_5bpdRKCRdunic");
        ...
        BoyFriend boyFriend = new BoyFriend("某男友",
                "江苏省", "南京市", "1999-08-08", "2011-04-16", "oHapj6IiKHSeTW_5bpdRKCRdunic", "h7IF7kerzmEZS9O75mpirHpF_Xjzy0kuMUtjSj7-vAk");
